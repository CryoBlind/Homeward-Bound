...
function scr_create_rope(numSegments, ropeTypePlayer1, ropeTypePlayer2, player1){
	...
	physics_joint_set_value(attach, phy_joint_reaction_force_x, 1_000_000_000_000_000_000_000_000);
	physics_joint_set_value(attach, phy_joint_reaction_force_y, 1_000_000_000_000_000_000_000_000);
	...
	for(i = 0; i < numSegments; i++){
		...
		if(abs(numSegments/2 - i) < 1) { //create knot
			...
			attatch_knot = physics_joint_revolute_create(last_rope, knot, host.x, host.y + offset_y, -1, -1, false, 0, 0, false, false);
			...
			physics_joint_set_value(attatch_knot, phy_joint_reaction_force_x, 1_000_000_000_000_000_000_000_000);
			physics_joint_set_value(attatch_knot, phy_joint_reaction_force_y, 1_000_000_000_000_000_000_000_000);
			last_rope = knot;
		}
